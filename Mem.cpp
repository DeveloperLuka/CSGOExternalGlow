...
uintptr_t Mem::getProcess(const wchar_t* proc)
{
...
uintptr_t Mem::getModule(uintptr_t procId, const wchar_t* modName)
{
...
uintptr_t Mem::getAddress(uintptr_t addr, std::vector<uintptr_t> vect)
{
